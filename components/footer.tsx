          ...
          <div className={styles.disclaimerParent}>
            ...
            <div className={styles.theInformationProvidedContainer}>
              ...
              <p className={styles.theInformationProvided}>
                ...
                all of your funds. Always conduct your own research and consult
                with a professional financial advisor before making any
              ...
              <p className={styles.theInformationProvided}>
                ...
                damages, or liabilities arising from its use, trading, or
                holding. By using this website and engaging with [Your Memecoin
                Name], you acknowledge and accept these risks.
              </p>
              <p className={styles.theInformationProvided}>
