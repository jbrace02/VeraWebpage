...
const FrameComponent4: NextPage<FrameComponent4Type> = ({ className = "" }) => {
  return (
    <section className={[styles.headerContentParent, className].join(" ")}>
      <div className={styles.headerContent}>
        <Image
          className={styles.headerBg2Icon}
          width={1920}
          height={1080}
          alt=""
        ...
        <div className={styles.abstractGreenBackgroundLighParent}>
          ...
          <Image
            ...
            height={1076}
            alt=""
            src="/rectangle-671.svg"
          />
          <div className={styles.bookmarkBorderParent}>
            <Image
                  ...
                  <div className={styles.section2}>
                    ...
                    <div className={styles.footer}>
                      <div className={styles.inputButton}>
                        ...
                        />
                        <MicrophoneIcon
                          microphoneIconPosition="relative"
                          microphoneIconTop="unset"
                          microphoneIconLeft="unset"
                          rectangleDivBackgroundColor="#eaedef"
                          rectangleDivBackgroundColor1="#eaedef"
                          vector197="pending_I1:8392;2085:17284;1681:11808"
                          rectangleDivBorder="1px solid #eaedef"
                        />
